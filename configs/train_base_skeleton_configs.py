...
parser.add_argument('--save_dir', default=str, type=str, help='path to save trained model checkpoints')
...
# Model
parser.add_argument('--tuning_mode', default='codeskeleton', type=str, help='tuning mode for training LMs')
parser.add_argument('--clone_cs_head', default=True, action='store_true', help='Optional: clone a seperate linear layer for codeskeleton generation')
