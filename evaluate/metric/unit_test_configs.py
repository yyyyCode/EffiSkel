...
parser.add_argument("-t","--test_path", default=str, type=str, help="Path to test samples")
parser.add_argument("--output_path", default=str,type=str, help="Path to output test results")
parser.add_argument("--code_path", default=str,type=str, help='Path to generated programs') 
